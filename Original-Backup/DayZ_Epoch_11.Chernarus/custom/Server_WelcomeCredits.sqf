...
_role1 = "Welcome to";
_role1names = ["[IGS] US Epoch Server"];
_role2 = "Admins";
_role2names = ["Maestro_Roel","Hoglishva"];
_role3 = "Use Scroll options to spawn bike and make Upgrades";
_role3names = ["Upgrade your Bike to MotorBike then Mozzie"];
_role4 = "Your Spawned Bike/Mozzie will Disappear after restart";
_role4names = ["Use your Spawned Bike/Mozzie to make your new home"];
_role5 = "Teamspeak Channel";
_role5names = ["5.9.226.69:9988"];
 
{
	sleep 2;
	_memberFunction = _x select 0;
	_memberNames = _x select 1;
	_finalText = format ["<t size='0.60' color='#FFFFFF' align='right'>%1<br /></t>", _memberFunction];
	_finalText = _finalText + "<t size='0.90' color='#C80000' align='right'>";
