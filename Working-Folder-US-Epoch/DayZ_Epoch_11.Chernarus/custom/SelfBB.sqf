...
// CONFIG START																																						\\
//------------------------------------------------------------------------------------------------------------------------------------------------------------------\\
_useTime = 30; //Time in seconds before being able to use again.
_bloodAmount = 8000; //Amount of blood the bloodbag gives to player (gets multiplied in hosp/ambulance, so 4000 = 8000 in hospital and 6000 near ambulance)
...
_humanityAmount = 200; //Amount of humanity to give, if _giveHumanity = true
